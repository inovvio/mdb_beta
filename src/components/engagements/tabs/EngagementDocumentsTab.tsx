...
interface EngagementDocumentsTabProps {
  control: Control<any>;
  errors: any;
}

export function EngagementDocumentsTab({ control, errors }: EngagementDocumentsTabProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium">Engagement Documents</h3>
        <Button
          type="button"
          variant="outline"
          size="sm"
